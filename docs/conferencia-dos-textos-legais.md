...
**Privacidade, seção 2. É falso como está escrito, e é a frase mais perigosa dos
dois documentos.**
...
**Privacidade, seção 6. O número está errado, e falta a metade que sai da VM.**
...
**Sugestão:** "Cópias de segurança do banco são mantidas por catorze dias na
...
**Privacidade, seção 2. Quase verdade, e a diferença cabe numa frase.**
...
**Sugestão:** "...é descartada. O servidor mantém no máximo o último quadro em
...
**A omissão maior, e a mais recente.** Os termos foram escritos quando tudo era
...
Falta, nos termos: o que custa, o que a versão grátis inclui, que os trinta dias
iniciais acabam e a conta **cai para o grátis sem perder nada**, como se cancela,
e se há reembolso. Essa última é justamente onde o Código de Defesa do
Consumidor tem regra própria (direito de arrependimento em sete dias para compra
fora do estabelecimento), e é assunto do advogado — mas ele precisa saber que
existe assinatura para aplicá-la.

Falta, na privacidade: os campos novos da conta — `plano`, `plano_ate` e a marca
de que o aviso de fim de teste foi enviado.

### L5 — Dados guardados que a lista não cita

A seção 1 da privacidade lista o que se guarda dos computadores. Desde então
apareceram dois:
...
- **A cláusula de não responsabilidade** dos termos, seção 4. Diante de
...
- **A conexão é direta quando a rede permite; senão passa por um relay que só
  ...
  poucas impossibilidades técnicas reais que os documentos poderiam alegar, e
  eles não alegam.
...
1. Corrigir L1, L2 e L3 **antes** de mandar ao advogado. São erros de fato, e
   pagar um profissional para revisar uma descrição errada é pagar duas vezes.
2. Escrever o que falta de L4 (assinatura) — mesmo em rascunho ruim. É mais
   barato o advogado corrigir um rascunho do que escrever do zero.
3. Levar L7 como lista de perguntas. Chegar com as perguntas prontas costuma ser
   a diferença entre uma consulta e um projeto.
4. Repetir esta conferência **sempre que o produto ganhar um recurso que toque
